...
- **Web platform** generates 93% of revenue vs Mobile 7%
...
2. **Fix the Mobile experience** — only 7% of revenue comes from mobile. 
   This is a major gap. Improving the mobile app could unlock significant growth.

3. **Credit card offers drive sales** — 74% of customers pay by credit card. 
   Partner with banks to offer exclusive discounts and increase conversion.

4. **Convert Guests to Members** — Guests generate only 4% of revenue. 
   A signup incentive (discount on first order as member) could significantly 
   increase loyalty and repeat purchases.

5. **Plan inventory around November** — peak month every year. 
   Stock up on Fashion and Home & Furniture before October.
...
| `ecommerce_queries.sql` | MySQL business queries |
